      ...
      <div className="flex items-center">
        ...
        <div className="w-full">
          ...
          <h3 className="text-lg font-[650] mb-1">
            <Link
              href={`/blog/${data.id}`}
              className="inline-flex relative hover:text-gold duration-150 ease-out before:scale-x-0 before:origin-center before:absolute before:inset-0 before:bg-yellow-200 dark:before:bg-yellow-300 before:opacity-30 before:-z-10 before:translate-y-1/4 before:-rotate-2 hover:before:scale-100 before:duration-150 before:ease-in-out"
            >
              {data.title}
            </Link>
          </h3>
